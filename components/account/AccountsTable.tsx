          ...
          {accounts?.map((account, key) => (
            <motion.tr
              ...
              className={`from-transparent to-black ${
                key !== accounts.length - 1 && "border-b-2 border-gray-900"
            ...
            >
              ...
              <td
                className={`px-4 capitalize py-3 ${
                  account.status === "pending" && "text-amber-500"
                } ${account.status === "successful" && "text-green-500"}  ${
                  account.status === "failed" && "text-red-500"
                }`}
              >
                {account.status}
              </td>
